...
resource "aws_iam_policy" "AWSCodePipelineServiceRole" {
  name        = "${var.environment}-AWSCodePipelineServiceRole"
  path        = "/"
...
resource "aws_iam_role_policy_attachment" "AWSCodePipelineServiceRole" {
  ...
  policy_arn = "${aws_iam_policy.AWSCodePipelineServiceRole.arn}"
}
...
resource "aws_iam_role_policy" "codebuild-policy" {
  ...
  name= "${var.environment}-code-build-policy"
